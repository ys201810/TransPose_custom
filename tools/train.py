...
def main():
    ...
    # ADD
    DATASET_ROOT = '/home/ys.201810/sports/TransPose/data/'
    ...
    # transpose_r.pyの def get_pose_netでネットワーク定義
    ...
    train_dataset = eval('dataset.'+cfg.DATASET.DATASET)(
        cfg, DATASET_ROOT, cfg.DATASET.TRAIN_SET, True,
    ...
    valid_dataset = eval('dataset.'+cfg.DATASET.DATASET)(
        cfg, DATASET_ROOT, cfg.DATASET.TEST_SET, False,
        transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])
